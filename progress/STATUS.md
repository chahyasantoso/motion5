...
| B2 | Real GSAP multi-stop compilation | In progress | `fix/B2-gsap-stop-compilation` | [GSAP adapter](../packages/core/src/adapters/interpolator/gsap.ts), [tests](../packages/core/test/contract/adapters.test.ts), [slice commits](https://github.com/chahyasantoso/motion5/commits/fix/B2-gsap-stop-compilation) | Real-GSAP implementation and contract test are on the branch; focused CI and recovery audit evidence are pending |
