...
**P1-12:** collapse the two observation-validation owners into one. `contract/validate-v5.ts` and `graph/ir.ts` + `graph/order.ts` currently disagree on edge identity, cycle algorithm, rule ids, and the diagnostics produced for the same authored mistake, and the validator's self-reference rule is inverted. Delete the recursive `hasCycle`, let the graph owner produce observation diagnostics, and deep-freeze the accepted project instead of returning the caller's own object. After that, the honest build/acceptance/failing-first/mutation gates (G-1, G-3, G-4, G-5, G-7).
...
- P1-11: [PR #77](https://github.com/chahyasantoso/motion5/pull/77), red [#31676209101](https://github.com/chahyasantoso/motion5/actions/runs/31676209101), green [#31676660768](https://github.com/chahyasantoso/motion5/actions/runs/31676660768), merged. Details in `progress/P1-11.md`.
- P1-7/P1-8: [PR #78](https://github.com/chahyasantoso/motion5/pull/78), red [#31677481009](https://github.com/chahyasantoso/motion5/actions/runs/31677481009), green [#31681320093](https://github.com/chahyasantoso/motion5/actions/runs/31681320093), merged [`c1e68d6`](https://github.com/chahyasantoso/motion5/commit/c1e68d6b67b12103b249af3adb570cd0a870eb6c). Details in `progress/P1-7-8.md`.
- P1-9: [PR #79](https://github.com/chahyasantoso/motion5/pull/79), red [#31677773123](https://github.com/chahyasantoso/motion5/actions/runs/31677773123), green [#31681653183](https://github.com/chahyasantoso/motion5/actions/runs/31681653183), merged [`5571da9`](https://github.com/chahyasantoso/motion5/commit/5571da91f3e38c85f3c596ec9240e8412f1cfa47). Details in `progress/P1-9.md`.

## Reopened gates

- E1/G-1/G-7: the declaration boundary is proven by a vitest case that shells out to `tsc`. There is still no per-package build with `outDir` and `exports` pointing at `dist`, no consumer smoke test importing the built entry from outside the workspace, and no build or dedicated end-to-end job on the required-check path.
...
- G-4: failing-first still derives its verdict from an exit code, counts modified tests, and runs without `set -e`.
- G-5/G-6: mutation score reporting is a tautology and the ratchet is one global number.

## Remaining work

- P1-12: unify validation ownership, fix the inverted self-reference rule, and deep-freeze accepted projects.
...
- Repair G-1/G-3/G-4/G-5/G-6/G-7, re-baseline mutation, rerun the rescue audit, then open rescue → main.
