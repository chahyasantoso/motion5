...
| X-1 | Flat projected input observations | In progress |

## Current next action

**X-1:** flatten input observations before local composition so upstream authored keys are visible to plugins and tracks. Prove it with a red then green publisher contract, then land the implementation in `GraphPublisher`.
...
- X-1 test-first: [PR #70](https://github.com/chahyasantoso/motion5/pull/70), test commit [`32d6e1f`](https://github.com/chahyasantoso/motion5/commit/32d6e1f98e876944d9c290843580ff4ff0e7dbcc), CI run [#31663378125](https://github.com/chahyasantoso/motion5/actions/runs/31663378125) in progress.
...
- Finish X-1 with failing-first red and green evidence.
