...
| B1 | Prepare-stage plugin contribution | Done | `fix/B1-track-contribution` | [track](../packages/core/src/domain/track.ts), [plugins](../packages/core/src/domain/plugins.ts), [test](../packages/core/test/unit/domain/track-contribution.test.ts), [slice log](B1.md) | Merged into rescue as [`74f885ca`](https://github.com/chahyasantoso/motion5/commit/74f885ca08f957bea1d552182fcdf33a2b62e70f); green slice [CI](https://github.com/chahyasantoso/motion5/actions/runs/31472986155); failing-first audit [#31483412238](https://github.com/chahyasantoso/motion5/actions/runs/31483412238) proved base `bec08ded` failed and ref `74f885ca` passed |
| B2 | Real GSAP multi-stop compilation | In progress | `fix/B2-gsap-stop-compilation` | [GSAP adapter](../packages/core/src/adapters/interpolator/gsap.ts), [tests](../packages/core/test/contract/adapters.test.ts), [slice commits](https://github.com/chahyasantoso/motion5/commits/fix/B2-gsap-stop-compilation) | Branch already exists from the rescue line and has real-GSAP test work in [`9912c2bb`](https://github.com/chahyasantoso/motion5/commit/9912c2bb7e1fb34db058444eafc6c8350d7be4ee), fixture correction in [`b3ecd5a`](https://github.com/chahyasantoso/motion5/commit/b3ecd5a52ee6fd33c3718b332c3528fcf4b00d35), and GSAP lockfile addition in [`bbc9eb3`](https://github.com/chahyasantoso/motion5/commit/bbc9eb3ec729356965529811921a478af51904bd). Implementation and green CI evidence are still pending |
...
Continue B2 on `fix/B2-gsap-stop-compilation`: finish the GSAP adapter implementation, run slice CI, then run the recovery audit against the B2 head with its rescue parent. Acceptance requires authored multi-stop values at progress `0`, `0.5`, and `1` using real GSAP. Do not merge to rescue until both focused CI and recovery evidence are green.
