...
- **Inspected main:** `4618469f0aae0ac908f9d1777256da82c4cc7280`, after the derived DOM binding [#361](https://github.com/chahyasantoso/motion5/pull/361). Exact CI and operation evidence belong to their PRs.
...
- **Unmerged read-budget headroom:** the first slice of [#362](https://github.com/chahyasantoso/motion5/issues/362) moves `runtime/project-runtime.ts`'s duplicated private reasoning into `runtime/project-runtime.md`, which is the prerequisite for the convenience-API items on that issue: the source stood at 57,567 bytes against the 60,000 byte budget. No behaviour, no public surface, no gate change. Review, exact-head CI, and merge remain gates; no landed change is claimed.
