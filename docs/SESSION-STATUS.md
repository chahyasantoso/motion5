...
- Open from the `T4` review, filed rather than folded in: issue [#133](https://github.com/chahyasantoso/motion5/issues/133), a rollback failure can outrank the failure that triggered it, in both `addMotion` and `#addTrack`. Issue [#134](https://github.com/chahyasantoso/motion5/issues/134) is closed, recorded above.
