...
- documented exception: E1 changes package metadata and declaration-build enforcement only; no new runtime behavior is introduced, and the declaration-build job is the executable evidence.
- verdict: exception
