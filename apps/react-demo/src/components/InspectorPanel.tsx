...
const NodeCard: React.FC<{ handle: ProjectHandle; nodeId: string; title: string }> = ({
  ...
  // A pose belongs to the render decision's `render` answer rather than to patch existence, and the
  // decision is core-owned because the DOM adapter and the React bindings read one four-status wire.
  //
